						...
						<div class="row align-items-center text-center my-5">
							...
							<div class="col-md-6 position-relative py-5">
								<div class="appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="500" style="animation-delay: 500ms;">
									<img class=" ls-is-cached lazyloaded" src=<?= Yii::getAlias('@web') ?>"/img/landing/porto_dots2.png" data-src=<?= Yii::getAlias('@web') ?>"/img/landing/porto_dots2.png" alt="" width="149" height="142" style="position: absolute; top: -60px; right: -8%;">
								</div>
								<div class="appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="0" data-appear-animation-duration="750" style="animation-delay: 0ms;">
									<div>
										<img src="<?= Yii::getAlias('@web') ?>/img/sie/logosie_v3.jpg" data-src="<?= Yii::getAlias('@web')?>/img/sie/logosie_v3.jpg" class="img-fluid border border-width-10 border-color-light rounded box-shadow-3 ls-is-cached lazyloaded" alt="Porto Admin">
...
<div class="row pb-3">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Estudiantes</h4>
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Docentes</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Administrativos</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Ciclos escolares</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Recursos Humanos</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Inscripciones Online</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Referencias Bancarias</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											<h4 class="font-weight-bold text-4-5 mb-1">Documentos</h4>
											<p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus blandit massa</p>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-4">
							<h2 class="font-weight-normal text-6">y más...</h2>
